        ...
        try {
         ...
         return {
              ...
              adotado: data.adotado || [],
               ...
               castracaoCount: extractCountValue(data.castracaoTotalCount),
               castracaoPorAno: data.castracao_count_by_year || [],
...
router.get(['/', '/home'], checkCookieConsent, async (req, res) => {
    try {
        ...
        res.render('home', {
            ...
            modelCastracaoPorAno: homePageData.castracaoPorAno,
